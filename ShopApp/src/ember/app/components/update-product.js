...
export default class UpdateProductComponent extends Component {
  ...
  update() {
    ...
    var selectedquan = document.getElementById('1' + p_name).value;
    var price = document.getElementById('2' + p_name).value;

    let url = 'http://localhost:8082/ShopApp/UpdateProduct';
    ...
    let fetchOptions = {
      ...
      body: `{p_name: "${p_name}", avlquan: "${selectedquan}", price: "${price}"}`,
    };
